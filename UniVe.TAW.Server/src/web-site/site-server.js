...
var SiteServer = /** @class */ (function () {
    function SiteServer(port) {
        if (!port)
    ...
    SiteServer.prototype.Routes = function () {
        var router = express.Router();
        this.ExpressApp.use('/', router);
    };
    return SiteServer;
}());
exports.default = SiteServer;
//# sourceMappingURL=site-server.js.map